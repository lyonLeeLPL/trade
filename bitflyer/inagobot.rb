...
while true
  ...
  if pos_size >= 0.01
    if pos_size >= 0.05 && position_side == "BUY"
      sell_ma(position_size)
    elsif pos_size >= 0.05 && position_side == "SELL"
      buy_ma(position_size)
    elsif ina == -1 && position_side == "BUY"
      sell_ma(position_size)
    elsif ina == 1 && position_side == "SELL"
      buy_ma(position_size)
    end
    sleep(5)
    cancel
  ...
  #   sell_li(price+ina, position_size)
  #   puts "売り指値"
  # elsif position_side == "SELL"
  #   buy_li(price+ina, position_size)
  #   puts "買い指値"
  # end
  # pri = price
  if ina == 1
  ...
  #   if position_side == "BUY"
  #     sell_li(pri+ina, position_size)
  #     puts "売り指値"
  #   elsif position_side == "SELL"
  #     buy_li(pri+ina, position_size)
  #     puts "買い指値"
  #   end
  #   sleep(5)
  # end
